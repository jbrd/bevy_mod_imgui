//! A Dear ImGui integration for the Bevy game engine. (imgui-rs backend)
//!
//! This module is only compiled when the `imgui-rs` feature is enabled.
//!
//! # Minimal Example
//!
//! ```no_run
...
use crate::renderer::imgui_wgpu::{RawTextureConfig, Renderer, RendererConfig, Texture};
